...
public class ManageRecycledItemsJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        ManageRecycMainJPanel.setBackground(new java.awt.Color(0, 102, 102));
        ...
        tblPickUpBooking.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        tblPickUpBooking.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null}
            },
            new String [] {
                "ItemID", "Computer Parts", "Weight(lbs.)", "Recieved on"
            }
        ) {
        ...
        btnSetPrice.setBackground(new java.awt.Color(204, 255, 204));
        btnSetPrice.setFont(new java.awt.Font("Castellar", 1, 12)); // NOI18N
        ...
        jLabel8.setText("Computer Parts");

        categoryDropDown.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        categoryDropDown.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Laptops", "Desktops", "Peripherals", "Semiconductor", "Cables", "Other" }));
