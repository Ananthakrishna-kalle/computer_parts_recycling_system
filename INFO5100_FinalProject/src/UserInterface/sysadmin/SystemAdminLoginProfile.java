...
public class SystemAdminLoginProfile extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        btnManageQCInspector.setBackground(new java.awt.Color(204, 255, 204));
        ...
        btnManageLogisticsSysadmin.setBackground(new java.awt.Color(204, 255, 204));
        ...
        btnManageIndividual.setBackground(new java.awt.Color(204, 255, 204));
        ...
        btnManageManagemnt.setBackground(new java.awt.Color(204, 255, 204));
        ...
        btnManageRetailers1.setBackground(new java.awt.Color(204, 255, 204));
        ...
        btnManageRetailer.setBackground(new java.awt.Color(204, 255, 204));
    ...
    private void btnManageQCInspectorMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnManageQCInspectorMouseClicked
        ...
        QualityCheckSysAdminJPanel manageSysadminQCInspector = new QualityCheckSysAdminJPanel(sysadminDynamicJPanel, ecosystem);
    ...
    private void btnManageLogisticsSysadminMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnManageLogisticsSysadminMouseClicked
        ...
        LogisticsSysAdminJPanel manageSysadminLogistics = new LogisticsSysAdminJPanel(sysadminDynamicJPanel, ecosystem);
        CardLayout layout = (CardLayout) sysadminDynamicJPanel.getLayout();
    ...
    private void btnManageIndividualMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnManageIndividualMouseClicked
        // TODO add your handling code here:
        IndividualSysAdminJPanel manageSysadminIndi = new IndividualSysAdminJPanel(sysadminDynamicJPanel, ecosystem);
        CardLayout layout = (CardLayout) sysadminDynamicJPanel.getLayout();
    ...
    private void btnManageManagemntMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnManageManagemntMouseClicked
        // TODO add your handling code here:
        MgmtDivSysAdminJPanel manageSysadminMgmt = new MgmtDivSysAdminJPanel(sysadminDynamicJPanel, ecosystem);
        CardLayout layout = (CardLayout) sysadminDynamicJPanel.getLayout();
    ...
    private void btnManageRetailerMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnManageRetailerMouseClicked
        // TODO add your handling code here:
        RetailerSysAdminJPanel manageSysadminRetailer = new RetailerSysAdminJPanel(sysadminDynamicJPanel, ecosystem);
        CardLayout layout = (CardLayout) sysadminDynamicJPanel.getLayout();
    ...
    private void btnManageTechnicianMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnManageTechnicianMouseClicked
        // TODO add your handling code here:
        TechSysAdminJPanel manageSysadminTechnician = new TechSysAdminJPanel(sysadminDynamicJPanel, ecosystem);
        CardLayout layout = (CardLayout) sysadminDynamicJPanel.getLayout();
