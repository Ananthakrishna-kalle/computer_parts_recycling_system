...
public class QCPastItemsHistoryJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        QCPastItemsHistory.setBackground(new java.awt.Color(0, 102, 102));
        ...
        itemsJTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Item ID", "Computer Parts", "Appliance", "Assigned Time", "Completed Time"
            }
        ) {
        ...
        itemsJTable.getAccessibleContext().setAccessibleParent(QCPastItemsHistory);
